...
const Page = () => {
    return (
        <div className="mx-auto p-4 flex flex-col justify-center items-center min-h-screen gap-4">
            ...
            <div className="rounded-3xl overflow-hidden shadow-lg bg-teal-900 text-white w-96 h-60">
                <div className="rounded-3xl overflow-hidden shadow-lg bg-teal-900 text-white w-96 h-28 border-b-2 border-white flex items-center justify-between mb-5">
                    <div className="block rounded-lg flex flex-col rounded-xl">
                        <div className="border-2 border-teal-900 rounded-xl p-4 flex flex-row justify-evenly items-center text-white">
                            <FontAwesomeIcon
                                icon={faPills}
                                size="5x"
